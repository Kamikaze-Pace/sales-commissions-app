...
import src.output.TXTReport;
import src.output.XMLReport;
...
public class ResultWindow extends JDialog {
	...
	//TODO: change the objects for sale to strings 
	...
	private void outputTXTButtonPressed(ActionEvent evt) {
		TXTReport makeTXTFile = new TXTReport(selectedSalesman);
	...
	private void outputXMLButtonPressed(ActionEvent evt) {
		XMLReport makeXMLFile = new XMLReport(selectedSalesman);
